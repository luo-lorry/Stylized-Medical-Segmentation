...
if __name__ == '__main__':
    src_dir = '../Dataset_Polyp/train_dataset/CVC-EndoSceneStill/CVC-612/test_split/masks_tif'
    dst_dir = '../Dataset_Polyp/train_dataset/CVC-EndoSceneStill/CVC-612/test_split/masks'
