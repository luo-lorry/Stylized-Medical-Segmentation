...
parser.add_argument('--pth_path', type=str, default='./snapshots-Skin/PraNet(original)/PraNet-39.pth')

for _data_name in ['test']:
    data_path = './Dataset/Dataset_Skin/{}/'.format(_data_name)
    save_path = './results/PraNet/{}-Skin/results(original)/'.format(_data_name)
