...
def main():
    ...
    parser.add_argument('--pth_path', type=str, default='./snapshots-Skin/UNet(style_transfer)/UNet-29.pth',
    ...
    for _data_name in data_names:
        ...
        save_path = './results/UNet/{}-Skin/results(style_transfer)/'.format(_data_name)
